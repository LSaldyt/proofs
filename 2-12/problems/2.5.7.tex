...
\begin{enumerate}
    ...
    \item Prove that every element of X is the union of a subset of $S$ with ${x}$, and that if you take different subsets of S you get different elements of $X$. Argue that, therefore, $X$ has the same number of elements as $\mathcal{P}(S)$ 
\end{enumerate}
